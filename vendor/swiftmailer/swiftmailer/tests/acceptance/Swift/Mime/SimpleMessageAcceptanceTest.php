...
class Swift_Mime_SimpleMessageAcceptanceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAttachmentsBeingAttached()
    {
        ...
        $attachment->setContentType('application/asd.pdf');
        $attachment->setFilename('foo.asd.pdf');
        $attachment->setBody('<asd.pdf data>');
        ...
        $this->assertRegExp(
            ...
            "\r\n\r\n".
            '--'.$boundary."\r\n".
            'Content-Type: application/asd.pdf; name=foo.asd.pdf'."\r\n".
            'Content-Transfer-Encoding: base64'."\r\n".
            'Content-Disposition: attachment; filename=foo.asd.pdf'."\r\n".
            "\r\n".
            preg_quote(base64_encode('<asd.pdf data>'), '~').
            "\r\n\r\n".
            '--'.$boundary.'--'."\r\n".
            '$~D',
            $message->toString()
