    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            for (var i = 0; i < change.length; i++) {
                var amdPriceTours = amdPrice.children(i);
                var asd = amdPriceTours.val();
                var usdPrice = parseInt(asd).toFixed();
            ...
            $('.link_button').on('click', function () {
                ...
                $('.link_button').html('<a href="{{ route('allToursEn') }}" class="moreTours">See all tours</a>')
            })
        });
